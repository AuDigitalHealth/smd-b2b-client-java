...
public class SealedMessageRetrievalClientTestHarnessTest {
    ...
    public void testTestHarness_R02_00() throws Exception {
        ...
        // Changed to use CertificateValidator version instead of deprecated CertificateVerifier one.
        ...
        List<TransportResponseType> transportResponses = new ArrayList<>();
        ...
        Assert.assertEquals(0, messageListType.getRetrievalRecord().size());
    }
